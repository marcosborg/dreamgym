...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $products = [
            ['name' => 'Sessão Única', 'name_en' => 'Single session', 'type' => Product::TYPE_SINGLE_HOUR, 'price_cents' => 800, 'sort_order' => 10, 'credits' => 1, 'days' => 90, 'seats' => 1, 'is_active' => true],
            ['name' => 'Pack 6', 'name_en' => 'Pack 6', 'type' => Product::TYPE_SESSION_PACK, 'price_cents' => 3600, 'sort_order' => 20, 'credits' => 6, 'days' => 90, 'seats' => 1, 'is_active' => true],
            ['name' => 'Pack 12', 'name_en' => 'Pack 12', 'type' => Product::TYPE_SESSION_PACK, 'price_cents' => 4800, 'sort_order' => 30, 'credits' => 12, 'days' => 90, 'seats' => 1, 'is_active' => true],
