            ...
            <form method="POST" action="{{ route('checkout.complete', $booking) }}" class="mt-8">
                ...
                @if ($paymentProvider === 'ifthenpay')
                    ...
                    <label class="mb-5 block">
                        ...
                        <input class="mt-2 w-full rounded border border-[var(--brand-stone)] px-4 py-3" name="mbway_phone" value="{{ old('mbway_phone', $booking->customer_phone) }}" placeholder="912345678">
                    </label>
