...
@section('content')
    ...
    <section class="section py-10">
        ...
        <div id="booking-flow" data-booking-flow>
        ...
        @if ($purchaseProducts->isNotEmpty())
            <form id="purchase-form" method="POST" action="{{ route('purchase.store') }}" class="mt-10 hidden max-w-3xl rounded-lg border border-[var(--brand-stone)] bg-white p-6">
                @csrf
