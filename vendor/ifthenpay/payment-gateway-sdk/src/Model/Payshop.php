...
class Payshop implements PaymentInterface
{
    ...
    public function __construct(string $amount, string $orderId, string $transactionId, string $reference, Status $status, ?DateTimeImmutable $expireDate = null, ?DateTimeImmutable $createdAt = null, ?DateTimeImmutable $updatedAt = null)
    {
    ...
    /**
     * Converts the Payshop object to an associative array.
